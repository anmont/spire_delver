...
public:
    ...
    */
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = Dungeon)
    int32 MaxItemFitnessFrames = 50000;
...
protected:
    ...
    TArray<AActor*> SpawnChunkPlaceableMarkers(const TArray<APlaceableMarkerActor*>& PlaceableMarkers, const FGuid& AbstractNodeId, const FBox& ChunkBounds, const FString& ChunkName);
    ...
    void TrySpawnPlaceableMarkers(UDungeonStreamingChunk* InChunk);
    
    UFUNCTION()
    void HandleChunkLoaded(ADungeon* InDungeon, UDungeonStreamingChunk* InChunk);
    
    UFUNCTION()
    void HandleChunkVisible(ADungeon* InDungeon, UDungeonStreamingChunk* InChunk);
