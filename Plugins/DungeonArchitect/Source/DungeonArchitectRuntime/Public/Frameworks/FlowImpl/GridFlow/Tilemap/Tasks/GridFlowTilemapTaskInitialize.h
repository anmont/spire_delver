...
public:
    ...
    virtual void LookAhead(const FFlowExecutionInput& Input) const override;
...
private:
    UGridFlowTilemap* BuildTilemap(UGridFlowAbstractGraph* Graph, const FRandomStream& Random) const;

    void PerturbRoomSizes(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery, const FRandomStream& Random) const;
    void FixCorridorSizes(FGridFlowTilemapNodes& TileNodes, const FFlowAbstractGraphQuery& GraphQuery) const;
    void InitRasterization(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
    void RasterizeRoomCorridors(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
    void GenerateMainPath(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
    ...
    void CalculateDistanceFromMainPath(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery,
                                       TArray<EGridFlowAbstractNodeRoomType> AllowedRoomTypes) const;
    void RasterizeBaseCaveBlocks(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
    void BuildCaves(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery, const FRandomStream& Random) const;
    static void GenerateCaveMap(FGFCaveCellBuildTiles& CaveMap, FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery);
    void BuildCaveStep_BuildRocks(FGFCaveCellBuildTiles& CaveMap, UGridFlowTilemap* Tilemap, const FRandomStream& Random) const;
    void BuildCaveStep_SimulateGrowth(FGFCaveCellBuildTiles& CaveMap, UGridFlowTilemap* Tilemap, const FRandomStream& Random) const;
    void BuildCaveStep_Cleanup(FGFCaveCellBuildTiles& CaveMap, FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
    static void BuildCaveStep_UpdateEdges(FGFCaveCellBuildTiles& CaveMap, UGridFlowTilemap* Tilemap);
    
private:
    void BuildDoors(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap, const FFlowAbstractGraphQuery& GraphQuery) const;
