...
public:
    ...
    static UFlowAbstractNode* CreateMergedCompositeNode(FFlowAbstractGraphQuery& GraphQuery, const FFlowAbstractNodeGroup& NodeGroup, const FRandomStream& InRandom);
    ...
    static UFlowAbstractNode* TryGetSubNodeFromLink(const FFlowAbstractGraphQuery& GraphQuery, const FGuid& InTargetNodeId, const UFlowAbstractLink* InLink);
};
