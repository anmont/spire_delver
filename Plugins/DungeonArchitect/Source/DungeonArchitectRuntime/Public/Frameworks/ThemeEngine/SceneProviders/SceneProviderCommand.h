...
protected:
    ...
    TObjectPtr<ULevel> LevelOverride = nullptr;
...
private:
    TObjectPtr<UPointLightComponent> LightTemplate;
};
...
private:
    TObjectPtr<UDungeonActorTemplate> ActorTemplate;
};
...
protected:
    TObjectPtr<AActor> ActorToReuse;
