...
FDungeonCanvasRoomShapeTextureList FSnapGridFlowGraphModDBItemImpl::GetCanvasRoomShapeTextures() {
    return Item.CanvasRoomShapeTextures;
}

TArray<FDungeonPointOfInterest> FSnapGridFlowGraphModDBItemImpl::GetPointsOfInterest() {
...
FSnapGridFlowModuleDatabaseImpl::FSnapGridFlowModuleDatabaseImpl(USnapGridFlowModuleDatabase* ModuleDB) {
    ...
    const USnapGridFlowModuleBoundsAsset* BoundsAsset = ModuleDB ? ModuleDB->ModuleBoundsAsset.LoadSynchronous() : nullptr;
    ChunkSize = BoundsAsset ? BoundsAsset->ChunkSize : FVector::ZeroVector;
}
