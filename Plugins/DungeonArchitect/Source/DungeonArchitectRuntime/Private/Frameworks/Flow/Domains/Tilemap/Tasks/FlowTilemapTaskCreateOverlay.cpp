...
void UFlowTilemapTaskCreateOverlay::Execute(const FFlowExecutionInput& Input,
                                                 const FFlowTaskExecutionSettings& InExecSettings, FFlowExecutionOutput& Output) const {
...
bool UFlowTilemapTaskCreateOverlay::GenerateOverlayValue(FFlowTilemapCell& Cell,
                                                              ...
                                                              const FGradientNoiseTable2D& NoiseTable, float& OutValue) const {
    ...
    if (N > NoiseSettings.NoiseThreshold) {
        ...
        float MinDistFromMainPath = FMath::Max(1, NoiseSettings.MinDistFromMainPath);
        const bool bInsertOverlay = (NoiseFactor * DistanceFromMainPath > MinDistFromMainPath);
