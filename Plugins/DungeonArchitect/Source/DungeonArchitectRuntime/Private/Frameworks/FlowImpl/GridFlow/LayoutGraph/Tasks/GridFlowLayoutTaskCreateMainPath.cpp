...
void UGridFlowLayoutTaskCreateMainPath::ExtendEntranceItem(UFlowGraphItem* InItem) const {
    if (UGridFlowGraphItem* GraphItem = Cast<UGridFlowGraphItem>(InItem)) {
        GraphItem->PlacementSettings = StartNodePlacement;
    }
}

void UGridFlowLayoutTaskCreateMainPath::ExtendExitItem(UFlowGraphItem* InItem) const {
    if (UGridFlowGraphItem* GraphItem = Cast<UGridFlowGraphItem>(InItem)) {
