...
FGuid FRandomUtils::CreateGuid(const FRandomStream& InRandom) {
    FGuid Guid;
    Guid[0] = InRandom.GetUnsignedInt();
    Guid[1] = InRandom.GetUnsignedInt();
    Guid[2] = InRandom.GetUnsignedInt();
    Guid[3] = InRandom.GetUnsignedInt();
    return Guid;
}
