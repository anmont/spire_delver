...
FDungeonFloorSettings UFloorPlanModel::CreateFloorSettings(const UDungeonConfig* InConfig) const {
    FDungeonFloorSettings Settings = {};
    if (const UFloorPlanConfig* FloorConfig = Cast<UFloorPlanConfig>(InConfig)) {
        Settings.FloorHeight = FloorConfig->GridSize.Z;
