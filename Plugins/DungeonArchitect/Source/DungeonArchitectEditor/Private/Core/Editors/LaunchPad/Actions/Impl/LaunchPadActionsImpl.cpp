                ...
                for (TActorIterator<ADungeon> It(World); It; ++It) {
                    ...
                    if (Dungeon) {
                        ...
                        if (USnapMapDungeonConfig* SnapConfig = Cast<USnapMapDungeonConfig>(Dungeon->GetConfig())) {
                            ...
                            {
                                if (USnapMapAsset* SourceFlowAsset = SnapConfig->DungeonFlowGraph.LoadSynchronous()) {
                                    FString ClonePackageName = CreateUniqueAssetName(
                                    ...
                                    if (ClonedFlowAsset) {
                                        Exec_OpenSnapFlow(ClonedFlowAsset->GetPathName());
                                    }
                                }
                            }
                            ...
                            {
                                if (USnapMapModuleDatabase* SourceModuleDB = SnapConfig->ModuleDatabase.LoadSynchronous()) {
                                    FString ClonePackageName = CreateUniqueAssetName(
