...
void FDungeonArchitectStyle::FStyle::Initialize() {
    ...
    // Placement styles
    {
		Set("PlacementBrowser.Icons.DungeonArchitect", new PLUGIN_IMAGE_BRUSH("Icons/Common/da_logo_16",          Icon16x16));
    ...
    // Editor Tools mode styles
    {
        ...
        // Style to be applied to customizable section headers so that the color shows up properly
        {
            ...
            Set("ModelingMode.WhiteExpandableAreaHeader", new FSlateRoundedBoxBrush(FSlateColor(FLinearColor::White), HeaderRadii));
        }
