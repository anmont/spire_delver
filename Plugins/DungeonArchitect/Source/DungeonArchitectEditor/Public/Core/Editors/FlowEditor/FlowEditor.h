...
private:
    virtual void FinalizeFlowGraphExecution(FFlowExecutionOutput& ResultNodeState, EFlowTaskExecutionResult& OutExecResult) {}
...
protected:
    ...
    TObjectPtr<UFlowEditorSettings> EditorSettings = nullptr;
