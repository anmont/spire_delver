...
private:
    TObjectPtr<USnapMapAsset> AssetBeingEdited = nullptr;
    TObjectPtr<UEdGraph_Grammar> VisualizationGraph = nullptr;
    TObjectPtr<UEdGraph_DebugGrammar> DebugGraph = nullptr;
    TObjectPtr<UFlowEditorDebugAppModeSettings> DebugModeSettings = nullptr;
