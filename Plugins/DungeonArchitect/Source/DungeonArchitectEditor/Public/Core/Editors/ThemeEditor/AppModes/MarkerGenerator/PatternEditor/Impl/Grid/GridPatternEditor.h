...
private:
	TObjectPtr<AGridPatternEdGroundActor> GroundPlaneActor = nullptr;
	TObjectPtr<AGridPatternEdCursorActor> CursorActor = nullptr;
	TObjectPtr<const UMGGridPatternEditorSettings> BuildSettings = nullptr;
