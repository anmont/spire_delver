 ...
 */
class DUNGEONARCHITECTEDITOR_API FEdModeDungeonLegacy : public FEdMode, public FEditorUndoClient {
public:

    /** Constructor */
    FEdModeDungeonLegacy();

    /** Destructor */
    virtual ~FEdModeDungeonLegacy();
    ...
    TObjectPtr<UDungeonEdModeHandler> GetHandler() const;
...
private:
    ...
    TObjectPtr<UDungeonEdModeHandler> ModeHandler;
