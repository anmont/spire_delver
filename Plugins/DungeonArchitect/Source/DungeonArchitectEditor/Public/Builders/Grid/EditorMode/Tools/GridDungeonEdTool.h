...
#include "Core/LevelEditor/EditorMode/Legacy/DungeonEdMode/IDungeonEdTool.h"
...
protected:
    ...
    TObjectPtr<UGridDungeonEdToolData> ToolModel;
    ...
    TObjectPtr<UGridDungeonEdModeHandler> ModeHandler;
