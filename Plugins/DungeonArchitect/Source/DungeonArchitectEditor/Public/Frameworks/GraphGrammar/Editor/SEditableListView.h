...
public:
    SLATE_BEGIN_ARGS(SEditableListView)
        ...
        SLATE_EVENT(FOnGetContent, OnGetAddButtonMenuContent)
        SLATE_EVENT(FOnGetContent, OnGetRemoveButtonMenuContent)
    SLATE_END_ARGS()
...
public:
    ...
    void Construct(const FArguments& InArgs) {
        ...
        OnGetAddButtonMenuContent = InArgs._OnGetAddButtonMenuContent;
        OnGetRemoveButtonMenuContent = InArgs._OnGetRemoveButtonMenuContent;
    ...
    TSharedRef<SWidget> CreateToolbarWidget() {
        ...
        {
            const FText AddButtonText = LOCTEXT( "AddItem", "Add" );
            const FText AddButtonTooltip = LOCTEXT( "AddNewItemPackagesTooltip", "Add a new Item" );
            if (OnAddItem.IsBound()) {
                AddButton = SNew(SPositiveActionButton)
                .Text(AddButtonText)
                ...
                .OnGetMenuContent_Lambda([this]() {
                    if (OnGetAddButtonMenuContent.IsBound()) {
                        return OnGetAddButtonMenuContent.Execute();
                    }
        ...
        TSharedPtr<SWidget> RemoveButton;
        {
            const FText RemoveButtonText = LOCTEXT("RemoveItem", "Remove");
            const FText RemoveButtonTooltip = LOCTEXT("SaveDirtyPackagesTooltip", "Remove selected Item");
            if (OnDeleteItem.IsBound()) {
                RemoveButton = SNew(SNegativeActionButton)
                ...
                .ToolTipText(RemoveButtonTooltip)
                .OnGetMenuContent_Lambda([this]() {
                    if (OnGetRemoveButtonMenuContent.IsBound()) {
                        return OnGetRemoveButtonMenuContent.Execute();
                    }
                    return SNullWidget::NullWidget;
                });
            }
    ...
    void RefreshListView() {
        ...
        ItemListView->SetSelection(NewSelectedItem, ESelectInfo::Direct);
    ...
    void SetItemSelection(ItemType ItemData, ESelectInfo::Type SelectInfo = ESelectInfo::Direct) {
        ...
        if (SelectedItem.IsValid()) {
            ItemListView->SetItemSelection(SelectedItem, true, SelectInfo);
...
private:
    ...
    FOnGetContent OnGetAddButtonMenuContent;
    FOnGetContent OnGetRemoveButtonMenuContent; 
